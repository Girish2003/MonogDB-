...
app.engine(
  "hbs",
  exhbs.engine({ layoutsDir: "views/", defaultLayout: "main", extname: "hbs",runtimeOptions:{
...
app.post("/store_book", async (req, res) => {
  ...
  // const collection = database.collection('books');
  let bookDetails = { title: req.body.title, author: req.body.author };
  // await collection.insertOne(book);
  const book = new bookModel(bookDetails);
  book.save();
